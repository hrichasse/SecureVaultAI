...
export const metadata: Metadata = {
  title: 'Restablecer contraseña — SecureVault',
}
...
export default async function ResetPasswordPage() {
  ...
  // Si no hay una sesión activa de Supabase, el enlace es inválido o expiró
  if (!user) {
      ...
      <div className="hidden lg:flex lg:w-1/2 gradient-hero items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center space-y-6">
          ...
          <p className="text-lg text-primary-foreground/80 max-w-md">
            Establece tus nuevas credenciales y reanuda el control de tus datos cifrados al instante.
          </p>
          <div className="flex items-center gap-2 justify-center text-primary-foreground/60 text-sm">
            <Lock className="h-4 w-4" />
            <span>Encriptación Extremo a Extremo · Autenticación Multifactor</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="space-y-2">
            <h2 className="text-2xl font-bold text-foreground">Establecer nueva contraseña</h2>
